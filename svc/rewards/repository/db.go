...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.setInProgressTransactionStmt, err = db.PrepareContext(ctx, setInProgressTransaction); err != nil {
		return nil, fmt.Errorf("error preparing query SetInProgressTransaction: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.setInProgressTransactionStmt != nil {
		if cerr := q.setInProgressTransactionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing setInProgressTransactionStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	setInProgressTransactionStmt         *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		setInProgressTransactionStmt:         q.setInProgressTransactionStmt,
