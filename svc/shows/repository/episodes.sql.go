...
const linkEpisodeChallenges = `-- name: LinkEpisodeChallenges :exec
UPDATE episodes
SET challenge_id = $1,
...
func (q *Queries) LinkEpisodeChallenges(ctx context.Context, arg LinkEpisodeChallengesParams) error {
	_, err := q.exec(ctx, q.linkEpisodeChallengesStmt, linkEpisodeChallenges, arg.ChallengeID, arg.VerificationChallengeID, arg.ID)
	return err
}
