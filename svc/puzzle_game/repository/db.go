...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.updatePuzzleGameAttemptStmt, err = db.PrepareContext(ctx, updatePuzzleGameAttempt); err != nil {
		return nil, fmt.Errorf("error preparing query UpdatePuzzleGameAttempt: %w", err)
	}
	return &q, nil
}
...
func (q *Queries) Close() error {
	...
	if q.updatePuzzleGameAttemptStmt != nil {
		if cerr := q.updatePuzzleGameAttemptStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updatePuzzleGameAttemptStmt: %w", cerr)
		}
	}
	return err
}
...
type Queries struct {
	...
	updatePuzzleGameAttemptStmt     *sql.Stmt
}
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		updatePuzzleGameAttemptStmt:     q.updatePuzzleGameAttemptStmt,
	}
}
