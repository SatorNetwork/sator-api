...
func calculateUserRewardsForGame(conf configer, nftType string, complexity, result int32) (float64, error) {
	...
	default:
		return 0, fmt.Errorf("invalid game result")
	}
	...
	if err != nil {
		return 0, fmt.Errorf("failed to get viewers_multiplier: %w", err)
	}
