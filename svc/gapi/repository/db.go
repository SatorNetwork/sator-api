...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	q := Queries{db: db}
	var err error
	if q.addElectricityToPlayerStmt, err = db.PrepareContext(ctx, addElectricityToPlayer); err != nil {
		return nil, fmt.Errorf("error preparing query AddElectricityToPlayer: %w", err)
	}
	...
	if q.selectCharacterToPlayerStmt, err = db.PrepareContext(ctx, selectCharacterToPlayer); err != nil {
		return nil, fmt.Errorf("error preparing query SelectCharacterToPlayer: %w", err)
	}
...
func (q *Queries) Close() error {
	var err error
	if q.addElectricityToPlayerStmt != nil {
		if cerr := q.addElectricityToPlayerStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing addElectricityToPlayerStmt: %w", cerr)
		}
	}
	if q.addNFTStmt != nil {
	...
	if q.resetElectricityForPlayerStmt != nil {
		if cerr := q.resetElectricityForPlayerStmt.Close(); cerr != nil {
	...
	if q.selectCharacterToPlayerStmt != nil {
		if cerr := q.selectCharacterToPlayerStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing selectCharacterToPlayerStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	selectCharacterToPlayerStmt       *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		selectCharacterToPlayerStmt:       q.selectCharacterToPlayerStmt,
