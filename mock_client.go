...
import (
	...
	solana "github.com/SatorNetwork/sator-api/lib/solana"
...
func (m *MockInterface) GetConfirmedTransaction(arg0 context.Context, arg1 string) (solana.GetConfirmedTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConfirmedTransaction", arg0, arg1)
	ret0, _ := ret[0].(solana.GetConfirmedTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInterface) GetConfirmedTransactionForAccount(arg0 context.Context, arg1, arg2, arg3 string) (solana.ConfirmedTransactionResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConfirmedTransactionForAccount", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(solana.ConfirmedTransactionResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInterface) GetNFTMetadata(arg0 string) (*solana.ArweaveNFTMetadata, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNFTMetadata", arg0)
	ret0, _ := ret[0].(*solana.ArweaveNFTMetadata)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInterface) GetNFTsByWalletAddress(arg0 context.Context, arg1 string) ([]*solana.ArweaveNFTMetadata, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) GetTransactions(arg0 context.Context, arg1, arg2, arg3 string) ([]solana.ConfirmedTransactionResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) GetTransactionsWithAutoDerive(arg0 context.Context, arg1, arg2 string) ([]solana.ConfirmedTransactionResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockInterface) PrepareSendAssetsTx(arg0 context.Context, arg1 string, arg2, arg3 types.Account, arg4 string, arg5 float64, arg6 *solana.SendAssetsConfig) (*solana.PrepareTxResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PrepareSendAssetsTx", arg0, arg1, arg2, arg3, arg4, arg5, arg6)
	ret0, _ := ret[0].(*solana.PrepareTxResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInterface) SendAssetsWithAutoDerive(arg0 context.Context, arg1 string, arg2, arg3 types.Account, arg4 string, arg5 float64, arg6 *solana.SendAssetsConfig) (string, error) {
	m.ctrl.T.Helper()
